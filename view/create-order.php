	...
	<form action="" method="POST">
		<table align="center">
			...
			<tr>
				...
				<td>: <span class="green f20"> <?php echo $foodname ?></span>
					  <input type="hidden" name="foodname" id="foodname" value="<?php echo $foodname ?>"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<span id="payment_methodErr" class="red">*</span></td>
			</tr>
			<tr>
