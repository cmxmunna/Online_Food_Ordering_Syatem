...
function peymentGetway()
{
  ...
  document.getElementById("numberBoxLoad").innerHTML = ": <input type='text' name='number' id='number'>";
}
...
function AddFoodValidation() 
{
    ...
    if (foodname == "") 
    {
        document.getElementById("foodnameErr").innerHTML =
        " ⚠ Please fill the foodname field";
        return false;
    }
    else{
        document.getElementById("foodnameErr").innerHTML = "";
